...
namespace PrisonService.Data
{
    public static class GenereatorStub
    {
        ...
        {
            Prisoner.Create("Яппаров Дияр Рафаэльевич", Adresses.First(), new DateTime(2002, 12, 2), "мужской", "1233 344124", "Женат", "Неполное средне-специальное", null,
            "Особо опасен", "104", new DateTime(2034, 4, 12), Prisons.First(), true, "Облысенние, гипотит", true, "89494221222", false),
            Prisoner.Create("Карпов Данил Дмитриевич", Adresses.Last(), new DateTime(2003, 7, 27), "мужской", "4221 124124", "Не женат", "Средне-специальное", null,
